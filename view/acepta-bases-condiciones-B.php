          ...
          <div class="bold">
            ...
            <div>
              ...
              <ul>
                ...
                <li>“Premio/s Moto Eléctrica”: consiste en la entrega de 4 (cuatro) Motos eléctricas modelo Apple marca Lucky Lion.</li>
                <li>“Premio/s GiftCard”: consiste en la entrega de 1 (una) “Gift Card Cencosud” y/o “Gift Card Master Card” y/o “Oh! Gift Card” por un valor de $3.000 (tres mil),  1 (una) “Gift Card Cencosud” y/o “Gift Card Master Card” y/o “Oh! Gift Card”  por un valor de $1.000 (pesos mil), 1 (una) “Gift Card Cencosud” y/o “Gift Card Master Card” y/o “Oh! Gift Card” por un valor de $500 (pesos quinientos) a cada supervisor y/o pdv según corresponda que haya cumplido con los objetivos establecidos en estas bases y condiciones. Se deja constancia de que la Gift Card Cencosud y/o Master Card y/o Oh! Gift Card: (i) será al portador; (ii) tendrá la vigencia que indicare dicha Gift Card; (iii) podrá ser canjeada en cualquier sucursal de Jumbo, Easy, Vea, Disco o Blaisten en el caso de la Gift Card Cencosud, en cualquier comercio que aceptara tarjeta Master card para el caso de la Gift Card Master card y en cualquier local que aceptara tarjeta Oh! Gift Card en el caso de esta tarjeta y (iv) estará sujeta a demás términos y condiciones que indicare la Gift Card respectiva, no teniendo MP responsabilidad alguna con respecto a sus cláusulas, canje ni a las decisiones que CENCOSUD pudiere tomar, por cualquier motivo, en relación a la Gift Card ni su utilización.</li>
                <li>“Programa”: es el Programa de incentivos y beneficios denominado “Go Marlboro”, sujeto a las presentes Bases.</li>
                <li>“Sitio”: Es el sitio web <a href="www.gomarlboro.com.ar" class="pointer"></a>, de acceso restringido, y al cual los supervisores de las KA Participantes podrán acceder a fin de llevar a cabo diferentes actividades relacionadas al Programa.</li>
              </ul>
            </div>
            ...
            <div>
              <p>5.1. El Programa ofrece la posibilidad de ganar: (i) 1 (uno) de los 4 (cuatro) Premios Moto Eléctrica disponibles; (ii) 1 (uno) de las 187 (ciento ochenta y siete) Premios Gift Card disponibles. Se deja expresa constancia que cada Premio incluirá el beneficio respectivo tanto para los empleados del  PDV que hubieren participado del Programa de acuerdo a las presentes Bases.</p>
            </div>
            <div>
            ...
            <div>
              <p>5.5. Finalizado cada etapa del programa, los PDV que, a las 23:59 hs, hubieren obtenido entre 80 y 100 puntos, serán considerados como potenciales ganadores de los Premios Gift Card (los “Potenciales Ganadores”) de acuerdo al siguiente detalle: los que obtengan entre 80 y 90 puntos serán Potenciales Ganadores del Premio Gift Card $500; los  que obtuvieran 100 puntos serán Potenciales Ganadores del Premio Gift Card $1000; Finalizadas las 2 (dos) etapas del Programa aquellos PDV que hayan resultado ganadores de gift cards de $1.000 en ambas etapas participarán por el sorteo de la Moto Eléctrica.</p>
            </div>
            <div>
